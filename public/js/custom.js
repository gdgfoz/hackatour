...
function mailchimpCallback(resp) {
  ...
  //
  // setTimeout(function () {
  //   var mockResp = {result : 'success', msg: 'Minha mensagem de teste'};
  //   mailchimpCallback(mockResp);
  // }, 5000);
  //
  // setTimeout(function () {
  //   var mockResp = {result : 'error', msg: 'Minha mensagem de teste error'};
  //   mailchimpCallback(mockResp);
  // }, 10000);
...
newYear = new Date(2016, 4, 16, 8,30);
